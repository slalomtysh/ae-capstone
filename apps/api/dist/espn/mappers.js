...
function deriveOutcomeLabel(rawEvent) {
...
export function mapGameSummary(rawEvent, sport) {
    const competitors = rawEvent?.competitions?.[0]?.competitors ?? [];
...
export function mapGameDetail(rawSummary, rawDetail, sport) {
