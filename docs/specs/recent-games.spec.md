...
- Render recent games list on home screen below Upcoming Games.
- Include final score, date/time, team records when available.
- Default window is rolling 7 days before today (today excluded; today belongs in Live Games).
...
- For favorites with completed games in the last 7 days before today, cards are shown.
- No games from today or older than 7 days are shown.
