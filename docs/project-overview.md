...
## Views / Screens
- Home (Live Games + Recent Games):
	- Live Games section shows live/in-progress games for favorite teams.
	- Recent Games section on the same screen shows favorite-team games from the last 7 days.
	- Both sections support stale-data presentation with a visible timestamp when served from cache.
- Game View:
